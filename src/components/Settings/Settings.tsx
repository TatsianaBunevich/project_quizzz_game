...
const Settings = ({
  ...
  const handleSliderChange = useCallback(
    (event: React.ChangeEvent<HTMLInputElement>, type: keyof SettingsType) => {
    ...
    () => (
      <div className={styles.sliderContainer}>
        <input
          ...
          onChange={(e) => handleSliderChange(e, 'amount')}
        />
    ...
    () => (
      <div className={styles.sliderContainer}>
        ...
        <input
          ...
          step="10"
          className={styles.slider}
          onChange={(e) => handleSliderChange(e, 'timer')}
        />
  ...
  return (
    <div className={styles.settings}>
      ...
      <Setting title="Difficulty">{memoizedDifficulty}</Setting>
      <Setting title="Type">{memoizedType}</Setting>
      <Setting title="Number of Questions">{memoizedAmount}</Setting>
      <Setting title="Timer (per question)">{memoizedTimer}</Setting>
    </div>
  )
}
